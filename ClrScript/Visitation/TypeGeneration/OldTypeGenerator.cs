...
namespace ClrScript.Visitation.Analysis
{
    class OldTypeGenerator
    {
        ...
        public OldTypeGenerator(ShapeCollection rootShapeCollection,
        ...
        {
            var methodShapes = _rootShapeCollection
                    .Select(p => p.Value)
                    .Where(p => p is OldMethodShape m && m.Declaration != null)
                    .Distinct()
                    .Cast<OldMethodShape>();
